...
CLASSIFICATION_RULES = [
    ...
    (r"MOJ-Transfer-Will-No-Ownership-.*\.csv", "MOJ", "transfer_will_no_ownership"),
    (r"MOJ-Transfer-Ownership-.*\.csv", "MOJ", "transfer_ownership"),
    (r"MOJ-Transfers-.*\.csv", "MOJ", "transfer"),
    (r"MOJ-POA-WhiteLandFee-.*\.csv", "MOJ", "poa_white_land_fee"),
    ...
    (r"MOJ-Enforcement-Sell-Property-.*\.csv", "MOJ", "enforcement_sell_property"),
    (r"MOJ-Enforcement-Auction-Sale-.*\.csv", "MOJ", "enforcement_auction"),
    (r"MOJ-Enforcement-Award-Buyer-.*\.csv", "MOJ", "enforcement_award"),
    ...
    (r"MOJ-Compensation-Ruins-.*\.csv", "MOJ", "compensation_ruins"),
    (r"MOJ-Compensation-.*\.csv", "MOJ", "compensation"),
    (r"MOJ-Grant-Alternative-.*\.csv", "MOJ", "grant_alternative"),
